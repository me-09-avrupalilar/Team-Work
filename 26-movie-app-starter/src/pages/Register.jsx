    ...
    <div className="overflow-hidden flex-1 h-screen justify-center items-center bg-[#23242a]">
      ...
      >
        <form className="absolute inset-[2px] rounded-[8px] bg-gray-100 dark:bg-[#28292d] z-[10] flex flex-col py-[50px] px-[40px]">
          ...
          <div>
            <input onChange={handleForm} id="firstName" name="floating_text" type="text" required />
            <label htmlFor="floating_text">First Name</label>
          </div>
          <div>
            <input onChange={handleForm}  id="lastName"  name="floating_text" type="text" required />
            <label htmlFor="floating_text">Last Name</label>
          </div>
          <div>
            <input  onChange={handleForm}   id="email" name="floating_email" type="email" />
            <label htmlFor="floating_email">Email</label>
          </div>
          <div>
            <input onChange={handleForm}  id="password" name="floating_password" type="password" />
